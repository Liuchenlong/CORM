...
class GCNMetaModel(object):
    ...
    def make_model(self):
        ...
        for i in range(target_n):
            ...
            #tv = tf.minimum(self.placeholders['target_v'][i], self.params['n_cluster'])
            ...
            #print(tf.nn.sparse_softmax_cross_entropy_with_logits(labels=node_labels,logits=self.node_out[:tv,:]).get_shape().as_list())
