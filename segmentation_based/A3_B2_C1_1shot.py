...
class GCNMetaModel(object):
    ...
    def make_model(self):
        ...
        with tf.variable_scope("graph_model", reuse = tf.AUTO_REUSE):
            ...
            support_final_node_representations = self.get_feature(self.placeholders['support_x'],self.placeholders['support_roi'],self.placeholders['is_training'])
            target_final_node_representations = self.get_feature(self.placeholders['target_x'],self.placeholders['target_roi'],self.placeholders['is_training'])
